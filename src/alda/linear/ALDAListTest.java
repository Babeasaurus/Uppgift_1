...
public class ALDAListTest {
	...
	// this in Moodle, and also update the tests there.
	 ...
	 list.add("Third");
	 list.add("Fifth");
	 assertEquals("[First, Second, Third, Fourth, Fifth, First, Third, Fifth]",
	 list.toString());
	 ...
	 private void testBeforeAndAfterRandomOperation(java.util.List<String>
	 oracle) {
